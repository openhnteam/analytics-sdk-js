...
import { variableTypeDetection, Logger } from '../../../utils'
 ...
 */
function getGlobalFirebirdSupport(): FIREBIRDGlobal {
  // @ts-ignore
  _global.__FIREBIRD__ = _global.__FIREBIRD__ || ({} as FIREBIRDGlobal)
  // @ts-ignore
